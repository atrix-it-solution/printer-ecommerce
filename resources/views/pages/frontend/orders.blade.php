                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endphp
                                                        <span class="badge text-uppercase fw-semibold rounded-pill {{ $statusClasses[$order->status] ?? 'bg-secondary' }}">
                                                            {{ ucfirst($order->status) }}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        ${{ number_format($order->total_amount, 2) }} for {{ $order->orderItems->sum('quantity') }} items
                                                    </td>
                                                    <td class="">
