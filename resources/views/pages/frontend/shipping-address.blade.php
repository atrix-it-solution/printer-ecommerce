                                        ...
                                        <form action="">
                                            <div class="row">
                                                <div class="form-group col-lg-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="shipping_fname" id="shipping_fname" placeholder="" value="" required />
                                                </div>
                                                <div class="form-group col-lg-6 mb-3">
                                                    <label for="shipping_lname">Last Name <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="shipping_lname" id="shipping_lname" placeholder="" value="" required />
                                                </div>
                                                <div class="form-group col-lg-12 mb-3">
                                                    <label for="shipping_company_name">Company Name (Optional)</label>
                                                    <input type="text" class="form-control" name="shipping_company_name" id="shipping_company_name" placeholder="" value="" />
                                                </div>
                                                ...
                                                <div class="form-group col-lg-12 mb-3">
                                                    <label for="shipping_streetaddress1">Street Address <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="shipping_streetaddress1" id="shipping_streetaddress1" placeholder="House number and street name" value="" required />
                                                </div>
                                                <div class="form-group col-lg-12 mb-3">
                                                    <label for="shipping_streetaddress2" class="d-none">Street Address</label>
                                                    <input type="text" class="form-control" name="shipping_streetaddress2" id="shipping_streetaddress2" placeholder="Apartment, suite, unit, etc. (optional)" value="" />
                                                </div>

                                                <div class="form-group col-lg-6 mb-3">
                                                    <label for="shipping_town_city">Town / City <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="shipping_town_city" id="shipping_town_city" placeholder="" value="" required />
                                                </div>
                                                <div class="form-group col-lg-6 mb-3">
                                                    <label for="shipping_postcode">Postcode <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="shipping_postcode" id="shipping_postcode" placeholder="" value="" required />
                                                </div>
                                                <div class="form-group col-lg-12 mb-3">
                                                    <label for="shipping_phonenumber">Phone Number (Optional)</label>
                                                    <input type="text" class="form-control" name="shipping_phonenumber" id="shipping_phonenumber" placeholder="" value="" />
                                                </div>
                                            </div>
