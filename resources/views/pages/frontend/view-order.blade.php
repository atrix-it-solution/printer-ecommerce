                        ...
                        <div class="col-lg-9 my-2">
                            <div class="account_right_side">
                                <div class="order_page">
                                    ...
                                    <p>Order <mark class="rounded-pill px-2">#{{ $order->order_number }}</mark> was placed on 
                                    <mark class="rounded-pill px-2">{{ $order->created_at->format('F d, Y') }}</mark> and is currently 
                                    <span class="badge bg-secondary fw-normal rounded-pill fs-14">{{ ucfirst($order->status) }}</span>.</p>
